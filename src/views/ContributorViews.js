...
exports.MintgAlgo = class extends React.Component {
  constructor(props){
    super(props)
  }
  render() {
  ...
  return (<> 
   <button  className="btn" onClick={() => parent.mint()}>Mint Galgo</button>
    <button className="btn" onClick={() => parent.continue()}>No continue</button>
    </>)
    }
}
  ...
  render() {
    ...
    return (
      <div class="form-style-5">
        Please paste the {thing} of the lottery Dapp.
        <br />
        <br />
        <fieldset>
        <input
